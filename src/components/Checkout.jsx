          ...
          <div className='lg:flex lg:justify-between'>
            ...
            <div className="relative overflow-x-auto shadow-md sm:rounded-lg mt-10">
              ...
              <div className='flex justify-end pr-10 my-8' style={{color: '#45595b'}}>
                <h3>Subtotal</h3>
                <span className='ml-20'>Rs224.00</span>
              </div>
              <hr />
              <div className='flex justify-center items-center my-20' style={{color: '#45595b'}}>
                ...
                <div className='ml-10 sm:ml-20'>
                  ...
                  <div>
                    ...
                    <label className='ml-2' htmlFor='flat'>Flat rate : Rs15.00</label>
                  </div>
                  <div>
                    <input type="checkbox" id='local'/>
                    <label className='ml-2' htmlFor='local'>Local Pickup: Rs8.00</label>
                  </div>
                </div>
              </div>
              <hr />
