        ...
        <div className='mt-40 px-6 py-10 sm:px-20 md:px-24 lg:px-16 xl:px-20' style={{backgroundColor: '#45595b'}}>
            <div className='py-10 lg:grid lg:grid-cols-3 lg:items-center xl:flex xl:justify-between '>
                ...
                <ul className='flex justify-end'>
                    <li className='mx-1'><a href="https://x.com/tejas_tagde" target="_blank" rel="noopener noreferrer"><i className='fab fa-twitter py-3 px-3 social rounded-full border border-orange-400'></i></a></li>
                    ...
                    <li className='mx-1'><a href="https://www.linkedin.com/in/tejas-tagde-aa5818328" target="_blank" rel="noopener noreferrer"><i className='fab fa-linkedin-in py-3 px-3 social rounded-full border border-orange-400'></i></a></li>
                </ul>
            </div>
            ...
            <div className='grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-y-8 lg:grid-cols-4'>
                ...
                <div>
                    ...
                    <div className='mt-5'>
                        <p className='footer-contact'>Address:Butibori,Nagpur</p>
                        <p className='footer-contact'>Email: tejastagde5@gmail.com</p>
                        <p className='footer-contact'>Phone: 9503244110</p>
